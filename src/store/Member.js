const Member = [
  {
    Team_J: [
      ...
      { member: "Diani Amalia Ramadhani" },
      { member: "Eve Antoinette Ichwan" },
      { member: "Feni Fitriyanti" },
      { member: "Fransisca Saraswati Puspa Dewi" },
      { member: "Frieska Anastasia Laksani" },
      { member: "Gabriel Angelina" },
      { member: "Gabriela Margareth Warouw" },
      { member: "Nabila Fitriana" },
      { member: "Nadila Cindi Wantari" },
